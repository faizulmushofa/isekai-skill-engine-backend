...
// ---------------------------------------------------------------------------
// All routes use Groq as primary provider.
// Gemini API key is not required for demo operation.
// MockAiGenerator serves as the ultimate failsafe if Groq is also unavailable.
// ---------------------------------------------------------------------------
